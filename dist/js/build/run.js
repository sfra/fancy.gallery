...
define(['stateSingleton', 'ImagesSet', 'libs/__ajax', 'plugins/order0', 'classes/Sequence', 'helpers/dom'], function (stateSingleton, ImagesSet, __ajax, order, Sequence, dom) {
    'use strict';
    ...
    function mainResolve(data) {
        ...
        document.getElementById('switch-left').addEventListener('click', function (e) {
